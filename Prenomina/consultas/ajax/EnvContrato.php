...
$queryS1 = "
            ...
            ".$compSql." and llaves.empresa = '".$IDEmpresa."' AND
...
class PDF extends FPDF
{
  ...
  function tabla($objBDSQL, $queryS1, $queryS2, $porcentaje, $fecha, $NombreEmp, $RegisEmp, $RFC, $NomDep)
  {
...
$pdf->SetFont('Arial', '', 8);
$pdf->AddPage();
$pdf->tabla($objBDSQL, $queryS1, $queryS2, $porcentaje, $fecha, $NombreEmpresa, $RegisEmpresa, $RFC, $NomDep);
