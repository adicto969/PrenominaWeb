...
<ul class="collapsible" data-collapsible="accordion">
  <li>
    <div class="collapsible-header" onclick="pruebaA(\'cod52\')"><span class="new badge" data-badge-caption="Total">'.$numr.'</span><i class="material-icons">mode_edit</i>Permisos</div>
  ...
  while($datos = $objBDSQL2->obtenResult2()){
      ...
      echo '
        <tr>
          ...
          <td class="Aline">'.substr($nombre, 5).'</td>
